...
var AccessTokenClient = /** @class */ (function () {
    function AccessTokenClient(vippsCredentials, useTestMode) {
        if (useTestMode === void 0) { useTestMode = false; }
    ...
    AccessTokenClient.prototype.get = function () {
                ...
                switch (_a.label) {
                    case 0:
                        if (this.tokenSet && !this.isExpired()) {
                            return [2 /*return*/, this.tokenSet.access_token];
                        }
                        return [4 /*yield*/, (0, http_request_1.post)(this.hostname, '/accesstoken/get', this.headers)];
                    case 1:
    ...
    AccessTokenClient.prototype.isExpired = function () {
        if (!this.tokenSet) {
            return true;
        }
        var maxValidTo = new Date();
