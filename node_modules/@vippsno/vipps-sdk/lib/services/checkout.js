...
var Checkout = /** @class */ (function () {
    function Checkout(configuration) {
    ...
    Checkout.prototype.createSession = function (requestData) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, (0, http_request_1.post)(this.vippsHostname, this.checkoutSessionPath, this.headers, requestData)];
            });
        });
    };
    Checkout.prototype.getSessionDetails = function (reference) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, (0, http_request_1.get)(this.vippsHostname, "".concat(this.checkoutSessionPath, "/").concat(reference), this.headers)];
            });
        });
    };
    return Checkout;
